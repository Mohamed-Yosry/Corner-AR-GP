  import 'package:corner_ar_gp/authentication/login/LoginPage.dart';
            ...
            children: <Widget>[
             ...
             _editingPassword?
                  EditPasswordForm(
                      ...
                      newPassSavedValue: _infoParameter.getNewPass(),
                      newConfirmationPassSavedValue: _infoParameter.getNewConfirmedPass(),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 10,),
                    Expanded(
                        child: _isDeleting? const Center(child: CircularProgressIndicator(),):
                        ElevatedButton(
                          onPressed: () => _infoParameter.deleteUser(widget.loggedUser, context, _toggleIsDeletingAccountLoading),
                          child: const Text(
                            'Delete Account',
                            style: TextStyle(
                              fontSize: 20,
